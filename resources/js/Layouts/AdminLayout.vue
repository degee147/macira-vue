                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('admin_profile')">
                                            Profile
                                        </DropdownLink>

                                        <DropdownLink :href="route('registered_users')">
                                            Registered Users
                                        </DropdownLink>
                                        <DropdownLink :href="route('admin_csv_import')">
                                            CSV Import
                                        </DropdownLink>

                                        <DropdownLink :href="route('admin_api_data')">
                                            API Data
                                        </DropdownLink>
