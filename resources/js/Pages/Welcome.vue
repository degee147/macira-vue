            ...
            <section
                ...
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                    ...
                    <h1
                        ...
                        NextPayDay Task Challenge</h1>
                    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
                        A Laravel multi auth (admin, users) system, with CSV import and remote api integration.
                        <br>Login using username or email
                        <br> Frontend
                        implemented using inertia with vue js
                    </p>
